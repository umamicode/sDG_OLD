...
#for w_info in 0.3 0.4 0.5 0.75 1.0
for w_oracle in 0.1 0.25 0.5 0.75 1.0 1.5 2.0
do  
# Model Load/Save Path
echo ${w_oracle}
svroot=saved-model/woracle_experiment/${data}/${gen}_${interpolation}_${backbone}_${loss_fn}_${pretrained}_${projection_dim}_${w_cls}_${w_cyc}_${w_info}_${w_div}_${div_thresh}_${w_tgt}_lmda${lmda}_oracle${oracle}_${w_oracle}_run${2}
