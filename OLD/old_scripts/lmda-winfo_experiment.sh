...
for lmda in 0.002 0.0051 0.007 0.01
do  
    for w_info in 0.01 0.025 0.05 0.1 0.2
    do
    svroot=saved-model/lmda-winfo_experiment/${data}/${gen}_${interpolation}_${backbone}_${loss_fn}_${pretrained}_${projection_dim}_${w_cls}_${w_cyc}_${w_info}_${w_div}_${div_thresh}_${w_tgt}_lmda${lmda}_run${2}
