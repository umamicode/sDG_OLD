...
backbone=resnet50 #resnet18/resnet50/wideresnet) 
pretrained=True #Only to load right base model. my_iter process is set as pretrained=False.
projection_dim=2048 #default: (mnist: 128/ cifar-10:128)
...
svroot=saved-model/oracle/${data}/${gen}_${interpolation}_${backbone}_${loss_fn}_${pretrained}_${projection_dim}_${w_cls}_${w_cyc}_${w_info}_${w_div}_${div_thresh}_${w_tgt}_lmda${lmda}_oracle${oracle}_${w_oracle}_lr${lr}_${lr_scheduler}_${optimizer}_run${2}
