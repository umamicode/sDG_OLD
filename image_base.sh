...
pretrained=False
projection_dim=128 #(custom default:128/ cifar_net default: 128) -max (8192,16384)
...
# Base Model Path
svroot=saved-model/fat_head/${data}/base_${backbone}_${pretrained}_${projection_dim}_run${2} 
