...
lr=1e-1 #for resnet18(not trainable afterwards): 1e-2/ for mnist_net: 1e-4 #og setting = 1e-4
lr_scheduler=cosine #none/cosine
optimizer=sgd #adam/sgd
# Base Model Path
svroot=saved-model/newbase/${data}/base_${backbone}_${pretrained}_${projection_dim}_run${2} 
